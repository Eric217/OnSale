...
- (CGSize)getImaSizeWithAsset:(ALAsset *)set {
    ...
    //[manager requestImageForAsset:set targetSize:<#(CGSize)#> contentMode:<#(PHImageContentMode)#> options:<#(nullable PHImageRequestOptions *)#> resultHandler:<#^(UIImage * _Nullable result, NSDictionary * _Nullable info)resultHandler#>]
