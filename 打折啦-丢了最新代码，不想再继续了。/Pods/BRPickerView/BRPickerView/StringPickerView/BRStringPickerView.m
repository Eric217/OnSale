...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    BRStringPickerView *strPickerView = [[BRStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect tintColor:color resultBlock:resultBlock];
    [strPickerView changeTintColor:color];
...
- (instancetype)initWithTitle:(NSString *)title
    ...
    self.color = color;
    [self changeTintColor:color];
    return self;
}

#pragma mark - 初始化子视图
- (void)initUI {
    [super initUI:self.color];
