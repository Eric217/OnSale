...
enum Identifier {
    static let cardCellId = "cardcellidentifier"
    static let goodsCellId = "goodscellidkasdalkd"
    static let mysuppleVId = "dajdnkhdbqhidjcl"
    static let meCellId = "sfdfawfafdsrfaf"
    static let upCellId = "dsefafasarar"
    static let toolCellId = "awaajafwEFSM"
    static let suppleId = "sdfwjnafhabrfw"
    static let txtVerifyId = "dafdwafewfawfaewf"
    static let pointReuseId = "dadhakchaydgwd"
    static let doubledeckerId = "sdaafwhfeguwefw"
}
